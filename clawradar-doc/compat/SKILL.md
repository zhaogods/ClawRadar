---
name: clawradar-workflow-legacy
description: 旧版根目录 skill 草案保留页；当前正式 skill 请使用 skills/clawradar-topic-radar/SKILL.md。
---
...
- [`skills/clawradar-topic-radar/SKILL.md`](skills/clawradar-topic-radar/SKILL.md)

说明：

- 正式 skill 目录名仍保留 `clawradar-topic-radar`；
- 当前项目主口径已经统一为 `ClawRadar`；
- 因此后续对外描述时，应以 `ClawRadar` 作为项目名称，以 `clawradar-topic-radar` 作为兼容 skill 标识。
...
- 正式 skill：[`skills/clawradar-topic-radar/SKILL.md`](skills/clawradar-topic-radar/SKILL.md)
- 项目使用文档：[`使用.md`](使用.md)
