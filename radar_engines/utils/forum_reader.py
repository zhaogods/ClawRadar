...
def get_latest_host_speech(log_dir: str = "outputs/logs") -> Optional[str]:
    """
...
def get_all_host_speeches(log_dir: str = "outputs/logs") -> List[Dict[str, str]]:
    """
...
def get_recent_agent_speeches(log_dir: str = "outputs/logs", limit: int = 5) -> List[Dict[str, str]]:
    """
