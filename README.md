...
- 正式 Skill 说明：[skills/openclaw-topic-radar/SKILL.md](F:\02_code\ClawRadar\skills\openclaw-topic-radar\SKILL.md)
...
- Skill 目录名仍保留 `openclaw-topic-radar`，主要是为了兼容早期命名与已有引用；
- 但当前项目对外主口径已经统一为 `ClawRadar`。
