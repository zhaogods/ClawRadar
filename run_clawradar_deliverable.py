...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--delivery-channel", choices=["archive_only", "feishu", "wechat"], default="wechat")
    parser.add_argument("--delivery-target", default="")
    parser.add_argument("--notification-channel", choices=["", "pushplus"], default="pushplus")
    parser.add_argument("--notification-target", default="")
    parser.add_argument("--notify-on", nargs="*", default=["run_completed", "run_failed", "publish_succeeded", "publish_failed"])
